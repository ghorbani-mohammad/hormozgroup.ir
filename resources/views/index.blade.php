...
@section('title', 'گروه هرمز تولید کننده سینی کابل و نردبان کابل')
@section('keywords', 'تولید کننده سینی کابل، تولید کننده نردبان کابل، تولید کننده رابط سینی کابل')
@section('description', 'گروه صنعتی هرمز در سال 1389 ایجاد شده است و تا به امروز در زمینه های مختلف تولید سینی کابل پرداخته ایم')
